...
from models.variational_models.variational_layer import VariationalLayer

class Dueling_QRDQN_varia1_model1(keras.Model):
    def __init__(self, input_dim1=220, input_dim2=6, n_actions=25, variational_dim=512, n_quantiles=51) :
        super().__init__()
        ...
        self.varia = VariationalLayer(self.variational_dim)
...
class Dueling_QRDQN_varia1_model2(keras.Model):
    def __init__(self, input_dim1=220, input_dim2=6, n_actions=25, variational_dim=512, n_quantiles=51) :
        super().__init__()
        self.input_dim1 = input_dim1
        self.input_dim2 = input_dim2
...
class Dueling_QRDQN_varia2_model1(keras.Model):
    def __init__(self, input_dim1=220, input_dim2=6, n_actions=25, variational_dim=512, n_quantiles=51) :
        super().__init__()
        self.input_dim1 = input_dim1
        self.input_dim2 = input_dim2
...
class Dueling_QRDQN_varia2_model2(keras.Model):
    def __init__(self, input_dim1=220, input_dim2=6, n_actions=25, variational_dim=512, n_quantiles=51) :
        super().__init__()
        self.input_dim1 = input_dim1
        self.input_dim2 = input_dim2
...
class Dueling_QRDQN_varia3_model1(keras.Model):
    def __init__(self, input_dim1=220, input_dim2=6, n_actions=25, variational_dim=512, n_quantiles=51) :
        super().__init__()
        self.input_dim1 = input_dim1
        self.input_dim2 = input_dim2
...
class Dueling_QRDQN_varia3_model2(keras.Model):
    def __init__(self, input_dim1=220, input_dim2=6, n_actions=25, variational_dim=512, n_quantiles=51) :
        super().__init__()
        self.input_dim1 = input_dim1
        self.input_dim2 = input_dim2
