...
class QRDQN_varia1_model1(keras.Model):
    def __init__(self, input_dim1=220, input_dim2=6, n_actions=25, variational_dim=512, n_quantiles=51) :
        ...
        self.z_val = layers.Dense(self.n_actions*self.n_quantiles, activation='linear')
    ...
    def call(self, inputs) :
        ...
        x = self.fc3(x)
        z_vals = self.z_val(x)
        distributions = layers.Reshape((self.n_actions, self.n_quantiles))(z_vals)
        return distributions

class QRDQN_varia1_model2(keras.Model):
    def __init__(self, input_dim1=220, input_dim2=6, n_actions=25, variational_dim=512, n_quantiles=51) :
        super().__init__()
        self.input_dim1 = input_dim1
        self.input_dim2 = input_dim2
...
class QRDQN_varia2_model1(keras.Model):
    def __init__(self, input_dim1=220, input_dim2=6, n_actions=25, variational_dim=512, n_quantiles=51) :
        super().__init__()
        self.input_dim1 = input_dim1
        self.input_dim2 = input_dim2
...
class QRDQN_varia2_model2(keras.Model):
    def __init__(self, input_dim1=220, input_dim2=6, n_actions=25, variational_dim=512, n_quantiles=51) :
        super().__init__()
        self.input_dim1 = input_dim1
        self.input_dim2 = input_dim2
...
class QRDQN_varia3_model1(keras.Model):
    def __init__(self, input_dim1=220, input_dim2=6, n_actions=25, variational_dim=512, n_quantiles=51) :
        super().__init__()
        self.input_dim1 = input_dim1
        self.input_dim2 = input_dim2
...
class QRDQN_varia3_model2(keras.Model):
    def __init__(self, input_dim1=220, input_dim2=6, n_actions=25, variational_dim=512, n_quantiles=51) :
        super().__init__()
        self.input_dim1 = input_dim1
        self.input_dim2 = input_dim2
