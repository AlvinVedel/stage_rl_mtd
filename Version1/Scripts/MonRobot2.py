...
def create_model(size):
    ...
    conv_layer1 = layers.Conv2D(64*4, kernel_size=(5, 5), strides=(2, 2), activation='relu', padding="valid")(encoding)
    conv_layer2 = layers.Conv2D(64*4, kernel_size=(3, 3), strides=(2, 2), activation='relu')(conv_layer1)
    ...
    #conv_layer5 = layers.Conv2D(256, kernel_size=(3, 3), strides=(2, 2), activation='relu')(conv_layer4)
