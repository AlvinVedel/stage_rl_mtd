...
if __name__ == '__main__':
    ...
    if os.path.exists('ALVIN2b_100_'+str(0)+'.keras'):
        modeltmp = tf.keras.models.load_model('ALVIN2b_100_'+str(0)+'.keras')
    ...
    while True:  # Run until solved
        ...
        if(episode_count%500==0):
            if episode_count <= 20000 :
                ...
                plt.ylim(-2, 15)
                plt.savefig('recompenses_1024_200.png')
                plt.close() 
                ...
                plt.ylim(0, 510)
                plt.savefig('steps_1024_200.png')
                plt.close() 
            ...
            for team in range(NM):
                model_target_[team].save('ALVIN2b_200_'+str(team)+'.keras')
                model_target_[team].save_weights('WALVIN2b_200_'+str(team)+'.weights.h5')
