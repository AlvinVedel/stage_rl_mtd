...
if __name__ == '__main__':
    ...
    model_target = tf.keras.models.load_model("./ALVIN3b_0.keras")
    ...
    while True:  # Run until solved
        liste_frames = []
        liste_frames_cone = []
        states = env.reset(inference=True, obstacles=4)
        ...
        input_path2 = "animations_inference/episode"+str(episode_count)+"CONE.gif"
