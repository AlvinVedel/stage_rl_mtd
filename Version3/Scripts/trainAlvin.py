...
if __name__ == '__main__':
    ...
    if os.path.exists('ALVIN_'+str(0)+'.keras'):
        modeltmp = tf.keras.models.load_model('ALVIN_'+str(0)+'.keras')
    ...
    while True:  # Run until solved
        ...
        if(episode_count%500==0):
            ...
            for team in range(NM):
                model_target_[team].save('ALVIN_'+str(team)+'.keras')
                model_target_[team].save_weights('WALVIN_'+str(team)+'.weights.h5')
