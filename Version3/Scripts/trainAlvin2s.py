...
if __name__ == '__main__':
    ...
    if os.path.exists('ALVIN2sb_fs_'+str(0)+'.keras'):
        modeltmp = tf.keras.models.load_model('ALVIN2sb_fs_'+str(0)+'.keras')
    ...
    while True:  # Run until solved
        ...
        if(episode_count%500==0):
            if episode_count <= 15000 :
                ...
                plt.ylim(-2, 15)
                plt.savefig('recompenses_sb_fs.png')
                plt.close() 
            ...
            for team in range(NM):
                model_target_[team][0].save('ALVIN2sb_fs_'+str(team)+'.keras')
                model_target_[team][0].save_weights('WALVIN2sb_fs_'+str(team)+'.weights.h5')
